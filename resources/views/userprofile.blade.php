...
<body>
    <a href="/posts/create" class="btn btn-primary" style="float: left; margin-left:7%;">Create Post</a>
    <div class="container-sm" style="margin-left: 85%">
    ...
    <form action="{{ route('userprofile.store', $useredit->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container-sm">
            ...
            <a href="/" class="btn btn-secondary" style="float: right;">Go Back</a>
        </div>
